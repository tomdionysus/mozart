  ...
  describe 'server integration', ->
    ...
    it 'should load all from server on model load', ->
      runs ->
        ...
        Test.Ajax.Customer.subscribeOnce('change', Test.Ajax.subcaller.onChange)
    ...
    it 'should load data from server on load with id', ->
      runs ->
        ...
        spyOn(Test.Ajax.subcaller,'onChange')
        Test.Ajax.Customer.subscribeOnce('loadComplete', Test.Ajax.subcaller.onLoad)
        Test.Ajax.Customer.subscribeOnce('change', Test.Ajax.subcaller.onChange)
    ...
    it 'should load data from server on instance load', ->
      runs ->
        ...
        spyOn(Test.Ajax.subcaller,'onChange')
        Test.Ajax.Customer.subscribeOnce('loadComplete', Test.Ajax.subcaller.onLoad)
        Test.Ajax.tom.subscribeOnce('change', Test.Ajax.subcaller.onChange)
        Test.Ajax.tom.load()
        Test.server.respond()
      waitsFor((-> Test.Ajax.subcaller.onChange.calls.length > 0), "onChange not fired", 1000)
      runs ->
    ...
    it 'should post data to server on save when instance isn\'t registered', ->
      runs ->
        ...
        spyOn(Test.Ajax.subcaller,'onChange')
        Test.Ajax.Customer.subscribeOnce('createComplete', Test.Ajax.subcaller.onCreate)
    ...
    it 'should put data to server on save', ->
      runs ->
        ...
        spyOn(Test.Ajax.subcaller,'onChange')
        Test.Ajax.Customer.subscribeOnce('updateComplete', Test.Ajax.subcaller.onUpdate)
    ...
    it 'should destroy on server and unregister on destroy', ->
      runs ->
        ...
        spyOn(Test.Ajax.subcaller,'onChange')
        Test.Ajax.Customer.subscribeOnce('destroyComplete', Test.Ajax.subcaller.onDestroy)
